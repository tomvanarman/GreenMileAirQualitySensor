...
void setup()
{
  ...
  // // Configure lengths
  // modem.sendAT("+SHCONF=\"URL\",\"http://cmb.blockleven.nl\"");
  // modem.waitResponse();
  ...
  // // Response example: +SHREQ: "GET",200,387
  // // Read response data
  ...
  writeCaFiles(3, "ca.cer", ca_cert, strlen(ca_cert));
  modem.sendAT("+CSSLCFG=\"convert\",1,\"ca.cer\"");
  modem.waitResponse();

  modem.sendAT("+CSSLCFG=\"sslversion\",1,3");
  modem.waitResponse();

  modem.sendAT("+SHSSL=1,\"ca.cer\"");
  modem.waitResponse();
  ...
  // /*********************************
  //  * step 6 : write all certificates
  //  **********************************/

  // // Write the CA root
  // writeCaFiles(3, "ca.crt", root_ca, strlen(root_ca));
  ...
  // /*********************************
  //  * step 8 : convert and bind SSL certificates
  //  **********************************/

  // // modem.sendAT("+CSSLCFG=\"SSLVERSION\",1,3");
  // // modem.waitResponse();
  // // modem.sendAT("+CSSLCFG?=\"CIPHERSUITE\",1");
  // // readModemResponse(5000);

  // // modem.sendAT("+CSSLCFG=\"ciphersuite\",1,\"0xC030\"");
  // // modem.waitResponse();
  // // modem.sendAT("+CSSLCFG?=\"PROTOCOL\",1");
  // // readModemResponse(5000);
